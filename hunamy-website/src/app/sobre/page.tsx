        ...
        <main className="min-h-screen bg-grafite-50 dark:bg-black text-grafite-900 dark:text-gray-100 font-sans antialiased transition-colors duration-300">
            ...
            <header className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
                <div className="absolute inset-0 z-0">
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-anil-900/40 via-black to-black animate-pulse"></div>
            ...
            {/* NOSSA HISTÓRIA */}
            <section className="py-24 bg-white dark:bg-grafite-900 relative overflow-hidden">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="order-2 lg:order-1">
                            ...
                            <div className="prose prose-lg dark:prose-invert text-gray-600 dark:text-gray-300">
                                ...
                                <p className="mb-6">
                                    A Hunamy nasceu da crença radical de que a inteligência artificial não deve substituir o ser humano - mas <strong className="text-grafite-900 dark:text-white font-bold">libertá-lo</strong> para fazer o que faz de melhor: <strong className="text-anil-500 font-bold">CRIAR</strong>.
                                </p>
                                <p className="mb-6">
                        ...
                        <div className="order-1 lg:order-2 relative h-[500px] rounded-2xl overflow-hidden shadow-2xl group">
                            ...
                            <img alt="Abstract representation" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" src="/images/sobre_stitch.png"/>
            ...
            {/* IDENTIDADE CENTRAL */}
            <section className="py-24 bg-grafite-50 dark:bg-black">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="mb-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(300px,auto)]">
                        <div className="md:col-span-2 relative group overflow-hidden rounded-2xl p-8 md:p-12 bg-white dark:bg-grafite-900 border border-gray-200 dark:border-white/5 shadow-lg hover:shadow-anil-500/10 transition-shadow duration-300">
            ...
            <section className="py-24 bg-white dark:bg-grafite-900 border-t border-gray-200 dark:border-white/5">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-16">
                        {[
                            { title: "Humanidade Acima de Tudo", desc: "Tecnologia serve pessoas, não o contrário. Empatia é competência obrigatória." },
